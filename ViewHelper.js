...
class ViewHelper extends Object3D {
  ...
  constructor(camera, renderer) {
    ...
    const helperViewport = new Vector4(
      renderer.domElement.offsetWidth - dim,
      renderer.isWebGPURenderer ? renderer.domElement.offsetHeight - dim : 0,
      dim,
      dim,
    );
    let radius = 0;
    ...
    this.handleClick = function (event) {
      ...
      mouse.x = (( event.clientX - rect.left + helperViewport.x ) / helperViewport.z ) * 2 - 1;
      mouse.y = renderer.isWebGPURenderer
